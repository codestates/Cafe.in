...
function MainInfoSection({ homeObjOne }) {
  return (
    <>
      <Styled.InfoSec lightBg={homeObjOne.lightBg}>
        <Container>
          ...
          <Styled.InfoColumn>
            ...
            <Styled.InfoColumn>
              <Styled.TextWrapper>
                <Styled.TopLine lightTopLine={homeObjOne.lightTopLine}>{homeObjOne.topLine}</Styled.TopLine>
                <Styled.Heading lightText={homeObjOne.lightText}>{homeObjOne.headline}</Styled.Heading>
                <Styled.Subtitle lightTextDesc={homeObjOne.lightTextDesc}>{homeObjOne.description}</Styled.Subtitle>
